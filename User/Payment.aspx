<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Chapter33.User.Payment" %>
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm" OnClick="lbCardSubmit_Click"
                                                ValidationGroup="card">Confirm Payment</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
