<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="Chapter33.Admin.OrderStatus" %>
                                                ...
                                                <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lbStatus" runat="server" Text='<%# Eval("Status") %>'
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server"
                                                                    CssClass="badge badge-primary" CommandArgument='<%# Eval("OrderDetailsId") %>' CommandName="edit">
                                                            <i class ="ti-pencil"></i>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfvOrderStatus" runat="server"
                                                            ...
                                                            ForeColor="Red" ControlToValidate="ddlOrderStatus" InitialValue="0"></asp:RequiredFieldValidator>
