<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Chapter33.Admin.Product" %>

<%@ Import Namespace="Chapter33" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                ...
                                                SetFocusOnError="true" ControlToValidate="textName"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                ...
                                                SetFocusOnError="true" ControlToValidate="textDescription">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                ...
                                                SetFocusOnError="true" ControlToValidate="textPrice"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                ErrorMessage="Price must be in decimal" ForeColor="Red" Display="Dynamic"
                                                SetFocusOnError="true" ControlToValidate="textPrice"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                ...
                                                SetFocusOnError="true" ControlToValidate="textQuantity"
                                            ...
                                            <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand" OnItemDataBound="rProduct_ItemDataBound">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img alt="" width="40" src="<%# Utils.GetImageUrl( Eval("ImageUrl")) %>" /></td>
                                                        ...
                                                        <td>
                                                            <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CausesValidation="false"
                                                                CssClass="badge badge-primary" CommandArgument='<%# Eval("ProductId") %>' CommandName="edit">
                                                            <i class ="ti-pencil"></i>
                                                            </asp:LinkButton>
